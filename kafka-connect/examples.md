...
## Check topic public.clients created
```shell
...
## Check new messages in topic public.clients
...
## Check postgres.clients index inElasticSearch - http://localhost:9200/postgres.clients/_search?pretty
